...
# 2. I will use an older static link using a specific old steam version of the arm64 (mentioned in the post) in which it will automatically update at install, if you want to grab the latest build look into both de-wim's and ubuntu asahi steam install scripts and valve's officical manifest 
